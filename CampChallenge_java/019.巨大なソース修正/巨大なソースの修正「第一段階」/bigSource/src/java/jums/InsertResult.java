...
public class InsertResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int a =Integer.parseInt((String)session.getAttribute("year"));
            int b =Integer.parseInt((String)session.getAttribute("month"));
            int c =Integer.parseInt((String)session.getAttribute("day"));
            birthday.set(a,b,c);
